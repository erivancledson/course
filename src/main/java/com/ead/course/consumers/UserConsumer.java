...
public class UserConsumer {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "${ead.broker.queue.userEventQueue.name}", durable = "true"), //cria a fila
    ...
    public void listenUserEvent(@Payload UserEventDto userEventDto) {
        ...
        //ele escuta o evento, pega os dados do dto e ver se o ActionType for CREATE ele salva.
