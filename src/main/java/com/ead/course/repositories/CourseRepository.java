...
public interface CourseRepository extends JpaRepository<CourseModel, UUID>, JpaSpecificationExecutor<CourseModel> {
    //se a consulta retornar maior que 0 retorna true se não retorna false
    ...
    @Modifying //deleta da tabela de relacionamento pelo id do curso
    ...
    @Modifying //deleta da tabela de relacionamento pelo id do usuario
